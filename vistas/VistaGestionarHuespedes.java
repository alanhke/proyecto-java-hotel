...
public class VistaGestionarHuespedes extends JPanel {
    ...
    public VistaGestionarHuespedes() {
        ...
        limpiar = crearBoton("🧹 Limpiar tabla huéspedes", new Color(158, 158, 158), Color.WHITE);
        crear = crearBoton("➕ Crear Huésped", new Color(76, 175, 80), Color.WHITE);
        modificar = crearBoton("✏️ Modificar Huésped", new Color(255, 193, 7), Color.BLACK);
        eliminar = crearBoton("🗑️ Eliminar Huésped", new Color(244, 67, 54), Color.WHITE);
